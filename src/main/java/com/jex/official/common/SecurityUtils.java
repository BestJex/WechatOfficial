...
public class SecurityUtils {
    ...
    private static String SHA256_KEY_START = "bTSXJeXlDu";
    private static String SHA256_KEY_END = "K*I**lk2";
    ...
    /**
     * 利用java原生的摘要实现SHA256加密（不可解密）
     * @param str 加密后的报文
     * @return
     */
    public static String SHA256WithKey(String str){
        MessageDigest messageDigest;
        String encodeStr = "";
        String txt = String.format("%s_%s_%s", SHA256_KEY_START, str, SHA256_KEY_END);
        try {
